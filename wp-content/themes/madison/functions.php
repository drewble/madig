...
function enqueue_scripts(){
    ...
    wp_enqueue_script('modernizr',  $template_dir . '/bower_components/modernizr/modernizr.js', false, '1', false);
    wp_deregister_script('jquery');
    if(is_page('Music')){
    wp_register_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js', false, '1.7.0', false);
    }else{
    wp_register_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js', false, '2.1.3', false);
	}
    wp_enqueue_script('jquery');
    wp_enqueue_script('foundation',  $template_dir . '/bower_components/foundation/js/foundation.min.js', array('jquery'), '1', true);
    wp_enqueue_script('topbar',  $template_dir . '/bower_components/foundation/js/foundation/foundation.topbar.js', array('foundation'), '1', true);
    wp_enqueue_script('responsive-nav',  $template_dir . '/_/js/responsive-nav.js', false, '1.0', true);
    wp_enqueue_script('fancybox',  $template_dir . '/_/js/jquery.fancybox.js', array('jquery'), '1.0', true);
    wp_enqueue_script('fancybox-media',  $template_dir . '/_/js/jquery.fancybox-media.js', array('fancybox'), '1.0', true);
    wp_enqueue_script('lettering',  $template_dir . '/_/js/jquery.lettering.js', array('fancybox'), '0.7.0', true);
    wp_enqueue_script('instafeed',  $template_dir . '/_/js/instafeed.min.js', false, '0.7.0', true);
    

    wp_enqueue_script('app',  $template_dir . '/_/js/app.js', array('jquery','foundation','topbar','fancybox-media','instafeed'), '1.0', true);

    if(is_page('Tour')){
      wp_enqueue_script('tour-dates',  $template_dir . '/_/js/tour-dates.js', array('jquery'), '2.2.1', true);
    }

    if(is_page('Music')){
    	wp_enqueue_script('soundcloud',  $template_dir . '/_/js/soundcloud.player.api.js', array('jquery'), '1.0', true);
    	wp_enqueue_script('sc-player',  $template_dir . '/_/js/sc-player.js', array('soundcloud'), '1.0', true);
    }

    wp_enqueue_style('fonts', 'http://fonts.googleapis.com/css?family=Lato:400,700,900|Montserrat:400,700', false, '1.0','all');
    wp_enqueue_style('app', $template_dir . '/_/css/app.css', array('fonts'), '1.0','all');
